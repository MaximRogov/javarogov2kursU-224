...
CREATE TABLE `abonent` (
  ...
  `numberPhoneOne` varchar(45) DEFAULT NULL,
  `numberPhoneTwo` varchar(45) DEFAULT NULL,
  `numberPhoneThree` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2023-12-05  1:22:10
